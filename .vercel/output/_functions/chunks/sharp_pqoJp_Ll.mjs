import { N as NoImageMetadata, Y as UnsupportedImageFormat, Z as AstroError, j as MissingSharp } from "./errors-data_ShoI2le8.mjs";
import { y as detector } from "./path_Bbq4GDGH.mjs";
import { i as resolveDefaultOutputFormat, n as baseService, r as parseQuality } from "./generic_Bx4bLOo_.mjs";
//#region node_modules/.pnpm/astro@7.2.4_@emnapi+core@1._aeb4984d6b38db31b82311836907e2c0/node_modules/astro/dist/assets/services/sharp.js
var sharp;
var qualityTable = {
	low: 25,
	mid: 50,
...
async function loadSharp() {
	let sharpImport;
	try {
		sharpImport = (await import("./dist_Cp5-vWQ-.mjs")).default;
	} catch {
